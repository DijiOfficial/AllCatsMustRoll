...
void SceneLoader::Pong()
{
    ...
    // paddle->AddComponents<ShapeRender>();
    ...
    // paddle->GetComponent<ShapeRender>()->SetRectangle(shape);
    // paddle->GetComponent<ShapeRender>()->SetFillColor(sf::Color::White);
    // paddle->GetComponent<ShapeRender>()->SetLineWidth(0.f);
    ...
    // ball->AddComponents<ShapeRender>();
    ...
    // ball->GetComponent<ShapeRender>()->SetRectangle(ballShape);
    // ball->GetComponent<ShapeRender>()->SetFillColor(sf::Color::White);
    // ball->GetComponent<ShapeRender>()->SetLineWidth(0.f);
